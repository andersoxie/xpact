...
See [docs/phase-1.md](docs/phase-1.md), [docs/benchmarks.md](docs/benchmarks.md), [docs/libexpat-api-compatibility.md](docs/libexpat-api-compatibility.md), and [docs/libexpat-parity.md](docs/libexpat-parity.md) for the current Windows Phase 1 scope.
