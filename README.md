...
This checkpoint contains a contract-enabled Eiffel streaming parser core, XML 1.0 tokenization, internal/external entity handling through an opt-in resolver policy, a SAX-style event handler interface, test and benchmark ECF targets, and the intended C ABI header for a libexpat-compatible surface.
