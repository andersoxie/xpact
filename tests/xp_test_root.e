...
feature {NONE} -- Tests
	...
	test_libexpat_adapter_files
		...
		do
			...
			assert ("expected-failure list has specific rows", l_expected.has_substring ("test_bypass_heuristic_when_close_to_bufsize") and l_expected.has_substring ("test_varying_buffer_fills"))
